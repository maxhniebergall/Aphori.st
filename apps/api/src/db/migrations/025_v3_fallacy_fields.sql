...
ALTER TABLE v3_nodes_s
  ADD COLUMN fallacy_type        TEXT,          -- e.g. 'AD_HOMINEM', 'STRAWMAN', 'NONE', 'EQUIVOCATION'
  ADD COLUMN fallacy_explanation TEXT;          -- 1-sentence LLM explanation of the detected fallacy
