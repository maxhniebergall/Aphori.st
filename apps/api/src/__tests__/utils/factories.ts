...
export class TestFactories {
  ...
  async createPost(
    ...
    const result = await this.pool.query(
      `INSERT INTO posts (id, author_id, title, content, analysis_content_hash, score, created_at, updated_at)
  ...
  async createReply(postId?: string, authorId?: string, overrides?: Partial<any>): Promise<any> {
    ...
    const result = await this.pool.query(
      `INSERT INTO replies (id, post_id, author_id, content, analysis_content_hash, depth, path, score, created_at, updated_at)
