                        ...
                        <div className="mb-6">
                            <label className="flex items-center">
                                ...
                                <span className="text-sm text-gray-600">
                                    <ul>
                                        <li>Anything you submit may be publicly visible and you are responsible for the content, legally and otherwise.</li>
                                        <li>Once content is submitted, you may not be able to edit or delete it.</li>
                                        <li>By posting content, you grant us a non-exclusive, worldwide, royalty-free license to use, reproduce, modify, distribute, and display your content.</li>
                                        ...
                                        <li>We reserve the right to change these terms at any time without prior notice. Any changes will be posted (or linked to) here.</li>
